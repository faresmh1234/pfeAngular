...
@Component({
  selector: 'app-dash-oneformation',
  templateUrl: './dash-oneformation.component.html',
  styleUrls: ['./dash-oneformation.component.css']
})
export class DashOneformationComponent implements OnInit {
...
if(this.mychart3){this.mychart3.destroy()}
 ...
 labels:labeldata,
  datasets: [{
   ...
   data:maindata,
    fill: false,
      backgroundColor:["#00E396","#3F9FFC"], // backgroundColor: [
